"""Alpha-beta search with the network as evaluator and move-orderer.

Policy logits drive move ordering for tighter cutoffs; the value head provides
leaf evaluations on a centipawn scale (inverted tanh(cp/600)). Iterative
deepening, a transposition table, quiescence on captures, and Zobrist-keyed
caching of network outputs are all wired in.
"""
